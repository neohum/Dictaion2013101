...
//			break;
    	...
    	case R.id.ib_timer:
    		Intent intent15 = new Intent(MainActivity.this, ResultActivity.class);
	...
	public void sendAppData(View v) throws NameNotFoundException {
		...
		metaInfoAndroid.put("installurl", "market://details?id=com.honeyv.dictation2013101");
		metaInfoAndroid.put("executeurl", "dictation2013101://IntroActivity");
