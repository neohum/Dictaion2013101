...
import com.honeyv.dictation2013101.R;

public class ThirdWritingActivity extends Activity {
	...
	public void soundPrepare(){
        //문제출력 소리준비
        int sound = getResources().getIdentifier("i" + text+"_"+1, "raw", this.getPackageName());
        ...
        int res = getResources().getIdentifier(text2 + text+"_"+1, "drawable", this.getPackageName());
	...
	public void mOnClick(View v){
		...
		case R.id.btn_num_01:
			flag = 1;
	        res = getResources().getIdentifier(text2 + text+"_"+1, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
		...
		case R.id.btn_num_02:
			flag = 2;
	        res = getResources().getIdentifier(text2 + text+"_"+2, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound2 = getResources().getIdentifier("i" + text+"_"+2, "raw", this.getPackageName());
		...
		case R.id.btn_num_03:
			flag = 3;
	        res = getResources().getIdentifier(text2 + text+"_"+3, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound3 = getResources().getIdentifier("i" + text+"_"+3, "raw", this.getPackageName());
		...
		case R.id.btn_num_04:
			flag = 4;
	        res = getResources().getIdentifier(text2 + text+"_"+4, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound4 = getResources().getIdentifier("i" + text+"_"+4, "raw", this.getPackageName());
		...
		case R.id.btn_num_05:
			flag = 5;
	        res = getResources().getIdentifier(text2 + text+"_"+5, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound5 = getResources().getIdentifier("i" + text+"_"+5, "raw", this.getPackageName());
		...
		case R.id.btn_num_06:
			flag = 6;
	        res = getResources().getIdentifier(text2 + text+"_"+6, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound6 = getResources().getIdentifier("i" + text+"_"+6, "raw", this.getPackageName());
		...
		case R.id.btn_num_07:
			flag = 7;
	        res = getResources().getIdentifier(text2 + text+"_"+7, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound7 = getResources().getIdentifier("i" + text+"_"+7, "raw", this.getPackageName());
		...
		case R.id.btn_num_08:
			flag = 8;
	        res = getResources().getIdentifier(text2 + text+"_"+8, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound8 = getResources().getIdentifier("i" + text+"_"+8, "raw", this.getPackageName());
		...
		case R.id.btn_num_09:
			flag = 9;
	        res = getResources().getIdentifier(text2 + text+"_"+9, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound9 = getResources().getIdentifier("i" + text+"_"+9, "raw", this.getPackageName());
		...
		case R.id.btn_num_10:
			flag = 10;
	        res = getResources().getIdentifier(text2 + text+"_"+10, "drawable", this.getPackageName());
	        dictationField.setImageResource(res);
	        
			int sound10 = getResources().getIdentifier("i" + text+"_"+10, "raw", this.getPackageName());
		...
		case R.id.btnPlay:
			try {
				...
				Toast.makeText(this, "번호를 선택해주세요.", Toast.LENGTH_SHORT).show();
			}
			break;
